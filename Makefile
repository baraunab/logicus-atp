...
OBJS = telaSala.o caixinhas.o recursos.o save.o dialogo.o main.o mudarTela.o telaInicial.o telaMenu.o telaJogo.o telaInput.o salas.o desafioCaixinhas.o telaGrimorio.o
